...
var ExpandTransition = Barba.BaseTransition.extend({
  ...
  zoom: function() {
    ...
    let titleMain = $('.item__title');
    console.log(cloned);

    tl
      .to(cloned, 0.5, { x: 0, width: screenWidth }, 0)
      .to(title, 0.5, { opacity: 0, onStart: () => $('.item').addClass('is-active') }, 0, 0);
    if (prevAll.length) {
  ...
  showNewPage: function() {
    ...
    timeline
      .fromTo(thetitle,1,{y:200},{y:0})
      .fromTo('.logo, .scrolldown',1,{opacity:0},{opacity: 1});
